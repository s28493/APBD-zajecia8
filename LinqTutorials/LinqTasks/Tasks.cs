...
public static partial class Tasks
{
    ...
    public static IEnumerable<object> Task10()
    {
        ...
        emps.Add(new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null });
    ...
    public static IEnumerable<object> Task11()
    {
        return Emps
            ...
            .Join(Depts,
                g => g.Key,
                dept => dept.Deptno,
                (g, dept) => new { Name = dept.Dname, NumOfEmployees = g.Count() });
    }
    ...
    public static IEnumerable<Dept> Task14()
    {
        ...
        return Depts
            .GroupJoin(deptCounts,
                dept => dept.Deptno,
                dc => dc.Deptno,
                (dept, dc) => new { dept, dc = dc.FirstOrDefault() })
            .Where(x => x.dc == null || x.dc.Count == 5)
            .Select(x => x.dept)
            .OrderBy(x => x.Dname);
    }
}